...
def main():
    ...
    parser.add_argument('threshold_find', type=int, help='Threshold value used for finding a reference frame in the base video')
    parser.add_argument('threshold_match', type=int, help='Threshold value used for finding a matching frame in the delta video')
    ...
    screen_width, screen_height = get_screen_resolution()
    logger.log(["Details"])
    logger.log(["Threshold used for finding a reference frame (threshold_find):", args.threshold_find])
    logger.log(["Threshold used for finding a matching frame (threshold_match):", args.threshold_match])
    logger.log(["Frame skip:", args.frame_skip])
    logger.log(["Max recommended frame skip for this video fps and duration threshold:", (args.duration * fps1 / 6)])
