...
def main():
    ...
    base_vid.set(cv.CAP_PROP_POS_FRAMES, 245)
    alt_vid.set(cv.CAP_PROP_POS_FRAMES, 240)
    ...
    output_video = cv.VideoWriter('Videos/Heading_synched.mp4', codec, fps, (output_width, output_height), True)
